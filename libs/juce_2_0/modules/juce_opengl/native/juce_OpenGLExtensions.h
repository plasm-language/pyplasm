...
#define JUCE_GL_BASIC_EXTENSION_FUNCTIONS(USE_FUNCTION, EXT_FUNCTION) \
    ...
    EXT_FUNCTION (glMapBuffer,void*, (GLenum p1,GLenum p2), (p1,p2))\
    EXT_FUNCTION (glUnmapBuffer,GLboolean,  (GLenum p1), (p1))\
    /*--*/
...
struct OpenGLExtensionFunctions
{
   ...
   //#if JUCE_WINDOWS && ! DOXYGEN VISUS!
   #if (JUCE_WINDOWS || JUCE_IOS) && !DOXYGEN
    typedef char GLchar;
