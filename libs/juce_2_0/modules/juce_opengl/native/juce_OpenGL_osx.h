...
public:
                   ...
                   const NativeContext* contextToShareWith)
    {
        NSOpenGLPixelFormatAttribute attribs[] =
        {
            ...
            #if 1
            //visus (changing copy instead of swap for flushBuffer)
            // see https://developer.apple.com/library/mac/#documentation/Cocoa/Reference/ApplicationKit/Classes/NSOpenGLContext_Class/Reference/Reference.html
            // see http://help.mworks-project.org/discussions/problems/2-external-display-flicker-under-snow-leopard
