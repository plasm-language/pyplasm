...
public:
  ...
  */
  ...
  virtual void onMouseDown(int button,int x,int y,Ray3f ray) {onMouse(MousePressed ,button,x,y,ray);}
  virtual void onMouseMove(int button,int x,int y,Ray3f ray) {onMouse(MouseMoved   ,button,x,y,ray);}
  virtual void onMouseUp  (int button,int x,int y,Ray3f ray) {onMouse(MouseReleased,button,x,y,ray);}
...
protected:
  ...
  */
  void onMouse(int type,int button,int x,int y,Ray3f ray);
