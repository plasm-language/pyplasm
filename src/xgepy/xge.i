...
//___________________________________________________________________________________
%typemap(cstype,out="Hpc[]") const std::vector<SmartPointer<Hpc> >&,std::vector<SmartPointer<Hpc> > "System.Collections.IEnumerable"
%typemap(csin,
	pre=" 
		if ($csinput == null) throw new ArgumentNullException(\"$csinput\");
	...
	) const std::vector<SmartPointer<Hpc> >&,std::vector<SmartPointer<Hpc> > "$csclassname.getCPtr(temp_$csinput)"
%typemap(csout, excode=SWIGEXCODE) std::vector<SmartPointer<Hpc> > {
    IntPtr cPtr = $imcall;$excode
    if (cPtr == IntPtr.Zero) return null;
...
%typemap(cstype,out="Batch[]") const std::vector<SmartPointer<Batch> >&,std::vector<SmartPointer<Batch> > "System.Collections.IEnumerable"
%typemap(csin,
	pre=" 
		if ($csinput == null) throw new ArgumentNullException(\"$csinput\");
	...
	) const std::vector<SmartPointer<Batch> >&,std::vector<SmartPointer<Batch> > "$csclassname.getCPtr(temp_$csinput)"
%typemap(csout, excode=SWIGEXCODE) std::vector<SmartPointer<Batch> > {
    IntPtr cPtr = $imcall;$excode
    if (cPtr == IntPtr.Zero) return null;
...
%typemap(cstype,out="Texture[]") const std::vector<SmartPointer<Texture> >&,std::vector<SmartPointer<Texture> > "System.Collections.IEnumerable"
%typemap(csin,
	pre=" 
		if ($csinput == null) throw new ArgumentNullException(\"$csinput\");
	...
	) const std::vector<SmartPointer<Texture> >&,std::vector<SmartPointer<Texture> > "$csclassname.getCPtr(temp_$csinput)"
%typemap(csout, excode=SWIGEXCODE) std::vector<SmartPointer<Texture> > {
    IntPtr cPtr = $imcall;$excode
    if (cPtr == IntPtr.Zero) return null;
